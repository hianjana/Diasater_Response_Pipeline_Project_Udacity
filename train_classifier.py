...
def load_data(database_filepath):
    ...
    sql = 'SELECT * FROM DisasterMessages'
...
def build_model():
    '''
    This functions creates a pipeline of various features: CountVectorizer, TfidfTransformer and StartingVerbExtractor.
    For model building, AdaBoostClassifier is used. 
...
def main():
    ...
    if len(sys.argv) == 3:
        ...
        model_evaluation(y_test, y_pred)  # Model 3 evaluation
